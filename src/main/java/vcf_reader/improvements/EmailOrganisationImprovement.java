 ...
 */
public class EmailOrganisationImprovement extends ReplacementByHomeImprovement {
	...
	public boolean apply(Contact contact) {
		List<ContactValueElement> allEmails = contact.getAllEmails();
		return super.apply(allEmails);
	}
}
